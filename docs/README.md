# 문서 인덱스 (Genomics Data Plane)

> docs/는 제품 코드처럼 관리합니다. (PR 리뷰 대상)

## 권장 읽는 순서
### 0) App Map (컨텍스트)
- 00_app-map/app-map_v0.1.5.md
- 00_app-map/glossary.md
...
### 2) ADR (왜? 결정 기록)
- adr/0001-no-node-crd.md

## TODO
- [ ] Phase 1/2/3 문서 트리 생성(빈 뼈대부터)
